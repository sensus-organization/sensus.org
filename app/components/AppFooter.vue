...
onMounted(() => {
    ...
    const cards = footerRef.value.querySelectorAll(".footer-card");
    ...
    <footer ref="footerRef" class="bg-sensus-gray-50">
        <div v-if="$route.path !== '/contact'" class="max-w-7xl mx-auto px-6 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="mt-auto">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            >
                                ...
                                <svg v-if="social.icon === 'youtube'" class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"
                                    />
                                </svg>
                                <svg v-if="social.icon === 'linkedin'" class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"
                                    />
                                </svg>
                                <svg v-if="social.icon === 'instagram'" class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                ...
                                <svg v-if="social.icon === 'tiktok'" class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                ...
                <div class="footer-card bg-sensus-red rounded-2xl p-5 text-white flex flex-col min-h-[220px]">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-semibold">Support Our Mission</h3>
                    </div>
                    <p class="text-white/80 text-sm mb-4">
                        Help us make a difference in healthcare innovation and support student teams worldwide.
                    </p>
                    <div class="mt-auto">
                        <a
                        ...
                        <p class="text-white/60 text-xs mt-2 text-center">Powered by Donorbox</p>
                    </div>
                </div>
            </div>
        </div>

        <div class="border-t border-sensus-gray-200">
